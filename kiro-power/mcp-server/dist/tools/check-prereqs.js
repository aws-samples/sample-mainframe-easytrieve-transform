...
exports.checkPrereqs = checkPrereqs;
...
async function checkPrereqs() {
    ...
    const stackStatus = await (0, aws_helpers_1.getStackStatus)("AtxInfrastructureStack");
    ...
    try {
        const listResponse = await (0, aws_helpers_1.invokeLambda)("atx-list-jobs", {});
...
//# sourceMappingURL=check-prereqs.js.map